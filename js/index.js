		...
		case "GO":
			if(angle==0){
					if(parseInt(getStyle(oTar,"top"))<=0){
						...
						oMov.top=parseInt(getStyle(oTar,"top"))-52*arr[1];
					}
			}else if(angle==180){
				if(parseInt(getStyle(oTar,"top"))>=520){
					...
					if(parseInt(getStyle(oTar,"left"))<=0){
						...
						oMov.left=parseInt(getStyle(oTar,"left"))-52*arr[1];
					}
			}else if(angle==90){
			...
			jd(arr,function(index){
				if(index==1){
					if(parseInt(getStyle(oTar,"left"))<=0){
						...
						oMov.left=parseInt(getStyle(oTar,"left"))-52*arr[2];
					}
				}else if(index==2){
					if(parseInt(getStyle(oTar,"left"))>=520){
						oTar.style.left=520+"px";
					...
					if(parseInt(getStyle(oTar,"top"))>=520){
						...
						oMov.top=parseInt(getStyle(oTar,"top"))+52*arr[2];
					}
				}else if(index==4){
					if(parseInt(getStyle(oTar,"top"))<=0){
						oTar.style.top=0+"px";
